  ...
  return (
    <div className="players">
      ...
      {data.data.players.map((player) => (
        ...
        <div key={player.id} className="player-card" id="delay">
          {/* Display the player's image, with the player's name as alt text */}
          <div className="player-image-container"><img className="player-image" src={player.imageUrl} alt={player.name} /></div>
